...
public class MeizhiAdapter extends RecyclerView.Adapter<MeizhiAdapter.MyItemFuliHoler> {
    ...
    public MeizhiAdapter(Context context, List<FuliBean.UserBean> fuliAdapters) {
        mContext = context;
