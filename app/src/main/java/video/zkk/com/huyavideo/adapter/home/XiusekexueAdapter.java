...
public class XiusekexueAdapter extends RecyclerView.Adapter<XiusekexueAdapter.MyItemFuliHoler> {
    ...
    public XiusekexueAdapter(Context context) {
        mContext = context;
    }

    public XiusekexueAdapter(Context context, List<FuliBean.UserBean> fuliAdapters) {
        mContext = context;
