 ...
 */
public class ShengHuoYuLeFragment extends Fragment implements OnRefreshListener,OnLoadMoreListener{
    ...
    ShengHuoYuLeAdapter mShengHuoYuLeAdapter;
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mShengHuoYuLeAdapter=new ShengHuoYuLeAdapter(getActivity());
        swipe_target.setLayoutManager(new LinearLayoutManager(getActivity()));
        swipe_target.setAdapter(mShengHuoYuLeAdapter);

        mShengHuoYuLeAdapter.setOnItemClickListener(new ShengHuoYuLeAdapter.OnItemClickListener() {
            @Override
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                swipeToLoadLayout.postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        mShengHuoYuLeAdapter.setList(mDataBeen);
                                    }
                                }, 10);
